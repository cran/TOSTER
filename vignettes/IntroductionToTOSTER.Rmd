...
**Warning: many of these functions are defunct and outdated. Please see the other vignettes for details on the new functions.**

The "Introduction to t_TOST" vignette, in particular, will be helpful. This vignette, and the functions used, will continue to be in the package for continuity purposes.
