...
dataTOSToneResults <- R6::R6Class(
    ...
    public=list(
        initialize=function(options) {
            super$initialize(options=options, name="", title="TOST One Sample T-Test")
