...
dataTOSTrOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "dataTOSTrOptions",
...
dataTOSTrResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
dataTOSTrBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "dataTOSTrBase",
